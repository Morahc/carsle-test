...
export const useRoomContext = () => {
  ...
  if (!context) {
    throw new Error("useRoomContext not in provider");
  }

  return context;
};

export const RoomProvider: React.FunctionComponent<{ children: ReactElement }> = ({ children }) => {
  ...
  return <RoomContext.Provider value={{ ws, me, peers, stream }}>{children}</RoomContext.Provider>;
};
